...
namespace Discount.Grpc.Services
{
    public class DiscountServices : DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        public override async Task<CouponModel> CreateDiscount(CreateDiscountRequest request, ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount is successfully creates. ProductName : {ProductName}", coupon.ProductName);
        ...
        public override async Task<CouponModel> UpdateDiscount(UpdateDiscountRequest request, ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount is updated. Product name : {ProductName}", coupon.ProductName);
